...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order_id, product_id, quantity, orderProd, newOrderProduct, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                orderProd = { quantity: quantity, order_id: order_id, product_id: product_id };
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.addOrderProduct(orderProd)];
            case 2:
...
var removeProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var OrderproductId, newOrderProduct, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                OrderproductId = parseInt(req.params.id);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.deleteOrderProduct(OrderproductId)];
            case 2:
                newOrderProduct = _a.sent();
                res.json(newOrderProduct);
                return [3 /*break*/, 4];
