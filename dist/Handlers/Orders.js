    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, orderStore.create(order.UserID, order.Order_status)];
            case 1:
                newOrder = _a.sent();
...
var CompletedOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderStore.showCompleted()];
            case 1:
                Orders = _a.sent();
                console.log(Orders);
...
var CurrentOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderStore.showCurrent()];
            case 1:
                Orders = _a.sent();
                return [2 /*return*/, res.json(Orders)];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, orderStore.showWithId(userId)];
            case 1:
                Orders = _a.sent();
                return [2 /*return*/, res.json(Orders)];
            case 2:
